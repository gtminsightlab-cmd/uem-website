...
const inquiryTypes = [
  {
    ...
    body: "A manufacturer or professional-practice group making a channel, provider-adoption, portfolio, network, or growth decision in medical aesthetics or professional skincare.",
  },
  {
          ...
          <div className="grid min-h-[660px] items-stretch lg:grid-cols-[1.08fr_0.92fr]">
            <div className="flex flex-col justify-center py-20 pr-0 md:py-24 lg:py-28 lg:pr-14">
              ...
              <p className="mt-8 max-w-3xl text-lg leading-8 text-white/72">
                A useful first conversation establishes the product or practice context, the
                decision at risk, the evidence already available, and where operator or specialist
                judgment may be needed.
              </p>
              <Link className="btn-outline-white mt-8" href="/employment-verification">
                Need job verification? Open the form →
              </Link>
            </div>
            ...
            <div className="relative min-h-[360px] overflow-hidden border-x border-t border-white/10 lg:min-h-full lg:border-y lg:border-r-0">
              <Image
                src="/images/uem-contact-conversation-hero.webp"
                alt=""
                fill
                priority
                quality={90}
              ...
              <div className="absolute bottom-0 left-0 right-0 border-t border-white/12 bg-navy/65 px-5 py-4 backdrop-blur-sm">
                <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-white/65">
                  Context · Evidence · Judgment · Next step
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-content grid gap-14 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="mt-5 font-serif text-h2 font-medium text-navy">
              Tell us what must be decided.
            </h2>
            <p className="mt-6 leading-8 text-mid">
              Every inquiry begins here so the right UEM teammate can understand
              its purpose and context. Share enough to frame the problem, but do
              not include protected health information, patient information,
            ...
            <div className="mt-8 border border-gray-200 bg-surface p-5">
              ...
              <p className="mt-2 text-sm leading-7 text-mid">
                HR teams, screening providers, agencies, and current or former
                workers should use the dedicated employment-verification form,
                including its optional secure document upload.
              </p>
              <Link
                className="mt-4 inline-flex min-h-11 items-center text-sm font-semibold text-navy underline decoration-gold underline-offset-4"
        ...
        <div className="container-content grid gap-8 md:grid-cols-3">
          {[
            [
              "1",
              "State the decision",
              "What must the leadership team choose, approve, sequence, or challenge?",
            ],
            [
              "2",
              "Share the context",
              "Where is the asset in its journey, and what evidence or constraints shape the decision?",
            ],
            [
              "3",
              "Define the next useful step",
              "UEM will be clear about fit, boundaries, and whether a specialist is required.",
            ],
