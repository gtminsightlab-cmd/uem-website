...
export const metadata: Metadata = createPageMetadata({
  title: 'RxLaunchOS for Pharmaceutical Commercial Teams',
  description:
    'RxLaunchOS connects role-based pharmaceutical commercialization plans, evidence-qualified scoring, governed simulations, risks, decisions, and execution.',
  path: '/launchos',
});
...
const competitiveAdvantages = [
  ...
  },
  {
    ...
    body: 'RxLaunchOS helps compare build, buy, rent, partner, and defer choices without acting as a captive CRM, CSO, data vendor, or agency.',
  },
];
        ...
        <div className="relative grid min-h-[680px] items-stretch lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)]">
            <div className="flex flex-col justify-center px-5 py-20 sm:px-6 md:px-12 md:py-24 lg:py-28 lg:pl-[max(3rem,calc((100vw-1400px)/2+3rem))] lg:pr-14">
              ...
              <h1 className="font-serif text-hero font-medium">
                Commercialize pharmaceutical products through the evidence, decisions, and teams that make a U.S. launch work.
              </h1>
            ...
            <div className="relative min-h-[360px] overflow-hidden border-x border-t border-white/10 lg:min-h-full lg:border-y lg:border-r-0">
              <Image
                ...
                alt="RxLaunchOS pharmaceutical launch readiness system connecting evidence, risks, decisions, and execution"
                fill
                priority
                quality={90}
        ...
        <div className="container-content">
          <FadeIn className="grid gap-8 border-l-2 border-gold py-3 pl-6 md:grid-cols-[0.35fr_1fr] md:items-center md:pl-10">
            ...
            <p className="max-w-3xl text-base leading-8 text-mid">
              RxLaunchOS translates UEM&apos;s pharmaceutical commercialization, launch execution,
          ...
          <FadeIn delay={0.1}>
            <div className="bg-gold p-8 text-white md:p-10">
              ...
              <Link href="/contact" className="btn-outline-white mt-7">
                Start an RxLaunchOS conversation <span aria-hidden="true">→</span>
              </Link>
